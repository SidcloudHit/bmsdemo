...
<html>
    <head>
        ...
        <title>TRBT || Upload Beneficiary Data </title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-primary">Upload Beneficiary Data</h4>
                            </div>
                            <div class="card-body bg-page font-weight-bold">
                               <form id="frmFileUpload" action="saveExcelData" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group row mx-auto required">
                                   ...
                                   <div class="form-group row mx-auto required">
                                       <label for="Installment" class="col-sm-3 col-form-label control-label" >Upload File :<span class="text-danger-small"><strong>( Max allowed size : 5120 KB )</strong></span></label>
                                       <div class="col-sm-7">
                                           <input type="file" name="fileExcel" id="fileExcel" class="form-control" required=""  onchange="return ValidateSize(this, 5120, 'excel');"/>
                                   </div>
                                   </div>        
                                   <div class="form-group row mx-auto required">
                                       ...
                                       <div class="col-sm-7">
                                           <input type="text" onkeypress="return IsNumeric(event);" class="form-control" maxlength="7" id="benificiary_count" name="benificiary_count" required="">
