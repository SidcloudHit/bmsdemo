...
<script>
                                                    $(document).ready(function () {
                                                        ...
                                                        $('#btnEsign').on('click', function (e) {
                                                            ...
                                                            var frameSrc = "";
                                                            if (applId !== '') {
                                                                frameSrc = "${pageContext.request.contextPath}/esign_certificate_request?purpose=1&serviceId=1&esignApplId=" + applId;
                                                            } else {
                                                                frameSrc = "${pageContext.request.contextPath}/esign_certificate_request?purpose=1&serviceId=1";
                                                            }
