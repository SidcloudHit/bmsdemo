                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header bg-info">
                                    <h4 class="text-white">Beneficiary Selection for DBT Cash:</h4>
                                </div>
                                    ...
                                    <div class="row d-none" id="benListDiv">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row" id="divSchemeMapping"> 
                                                <div class="input-group mb-3 col-md-4">
                                                    <button type="button" id="btnAdd" name="btnAdd" class="btn btn-success btn-block">
                                                        <strong>Initiate DBT for Selected Beneficiaries</strong>
                                                    </button>
                                                </div>
                                                    ...
                                                    $(document).ready(function () {
                                                        ...
                                                        $('#btnSearch').on('click', function (e) {
                                                            ...
                                                            table = $('#beneficiaryList').DataTable({
                                                                "ajax": {
                                                                    "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtin=1&finYr=" + finYr + "&instl=" + instl + "&officeId=" + officeId + "&blockId=" + blockId + "&gpId=" + gpId + "&schemeId=" + schemeId + "&land=" + land,
                                                                    "type": "POST"
                                                                },
                                                                "columnDefs": [
                                                                    {
                                                        ...
                                                        $('#btnAddNew').on('click', function (e) {
                                                            ...
                                                            if (schemeId === "" || officeId === "") {
                                                                alert("Kindly Select Scheme and Office for adding beneficiaries");
                                                                return false;
                                                            }

                                                            $.redirect("${pageContext.request.contextPath}/DEO/beneficiaryDataEntryNew.jsp?dbtType=1&scmId=" + schemeId + "&oId=" + officeId + "&pName=" + officeName + "&scmName=" + schemeName, null, "POST", "", null, true); //JSON.stringify(params)
                                                        });
                                                        ...
                                                        $('#btnAdd').on('click', function (e) {
                                                            ...
                                                            if (amount === "" || amount === "0") {
                                                                alert("Kindly Enter Amount for adding beneficiaries");
                                                                return false;
                                                            }

                                                            //var table = $('#beneficiaryList').DataTable({
                                                            //    "drawCallback": function (settings) {
                                                            //$('input:checkbox.dt-checkboxes').each(function () {
                                                            //    $(this).attr('checked', true);
                                                            //$(this).prop('readonly', true);
                                                            //});
                                                            //    }
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url: "${pageContext.request.contextPath}/DBTInitiateCash?finYr=" + finYr + "&instl=" + instl + "&amount=" + amount + "&schemeId=" + schemeId + "&land=" + land,
                                                                type: "POST",
                                                                dataType: 'json',
                                                                data: {json: json},
