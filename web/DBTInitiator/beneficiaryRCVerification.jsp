<%-- 
    Document   : beneficiaryRCVerification
    Created on : Jan 28, 2021, 11:58:48 AM
    Author     : NIC-Arindam
--%>
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#btnSearch').on('click', function (e) {
                                                    ...
                                                    table = $('#beneficiaryList').DataTable({
                                                        "ajax": {
                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtrcver=1&finYr=" + finYr + "&instl=" + instl + "&officeId=" + officeId + "&blockId=" + blockId + "&gpId=" + gpId + "&schemeId=" + schemeId,
                                                            "type": "POST"
                                                        },
                                                        "columnDefs": [
                                                            {
                                                    ...
                                                    $('#beneficiaryList tbody').on('click', 'button', function (e) {
                                                        if (parseInt(this.value) === 1) {
                                                            ...
                                                            $.redirect("${pageContext.request.contextPath}/BeneficiaryDataEntry?rcver=1&uniqueid=" + rowData['rc_mem'] + "&bankacno=" + rowData['bank_account'] + "&fullname=" + rowData['full_name'] + "&ifsc_code=" + rowData['ifsc'], null, "POST", null, true); //JSON.stringify(params)

//                                                            $.ajax({
//                                                                url: "${pageContext.request.contextPath}/BeneficiaryDataEntry?rcver=1&uniqueid=" + rowData['rc_mem'] + "&bankacno=" + rowData['bank_account'] + "&fullname=" + rowData['full_name'] + "&ifsc_code=" + rowData['ifsc'],
//                                                                type: "POST",
