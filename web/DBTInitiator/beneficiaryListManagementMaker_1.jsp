                                            ...
                                            <div class="row" id="divSchemeMapping"> 
                                                <div class="input-group mb-3 col-md-4">
                                                    <button type="button" id="btnFreeze" name="btnFreeze" class="btn btn-success btn-block">
                                                        <strong>Freeze and Esign Beneficiary List</strong>
                                                    </button>
                                                </div>
                                                    ...
                                                    $(document).ready(function () {
                                                        ...
                                                        $('#btnSearch').on('click', function (e) {
                                                            ...
                                                            /*$.ajax({
                                                             ...
                                                             url: "${pageContext.request.contextPath}/EsignWorks?search=3&officeId=" + officeId + "&schemeId=" + schemeId,
                                                             type: "POST",
                                                             async: false,
                                                             ...
                                                             url: "${pageContext.request.contextPath}/EsignWorks?search=4&officeId=" + officeId + "&schemeId=" + schemeId,
                                                             type: "POST",
                                                             async: false,
                                                             success: function (result) {
                                                             if (parseInt(result) > 0) {
