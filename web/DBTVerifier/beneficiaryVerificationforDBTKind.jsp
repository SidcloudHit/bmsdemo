<%-- 
    Document   : beneficiaryVerificationforDBTKind
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="text-white">Beneficiary Verification for DBT in Kind:</h4>
                        </div>
                        <div class="card-body bg-form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="ddlOffice" name="ddlOffice" class="form-control form-control-sm" required="required" onchange="resetBlock(2);dependentDropDown('ddlOffice', 'ddlOfficeMaker', 'fillChildOffice');">
                                            <%=ddlOffice%>                                                  
                                        </select>
                                    </div> 
                                </div>
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#btnSearch').on('click', function (e) {
                                                    ...
                                                    table = $('#beneficiaryList').DataTable({
                                                        "ajax": {
                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtver=2&finYr=" + finYr + "&instl=" + instl + "&blockId=" + blockId + "&storeId=" + storeId + "&schemeId=" + schemeId + "&land=" + land,
                                                            "type": "POST"
                                                        },
                                                        "columnDefs": [
                                                            {
                                                ...
                                                $('#btnAdd').on('click', function (e) {
                                                    ...
                                                    $.ajax({
                                                        url: "${pageContext.request.contextPath}/DBTVerifyKind?finYr=" + finYr + "&instl=" + instl + "&schemeId=" + schemeId + "&land=" + land,
