                                                    ...
                                                    $(document).ready(function () {
                                                                            ...
                                                                            success: function (result) {
                                                                                if (parseInt(result) > 0) {
                                                                                    ...
                                                                                    table = $('#beneficiaryList').DataTable({
                                                                                        "ajax": {
                                                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtrptver=1&finYr=" + finYr + "&instl=" + instl + "&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status,
                                                                                            "type": "POST"
                                                                                        },
                                                                                        "iDisplayLength": 50,
                                                                                        'order': [[1, 'asc']],
                                                        ...
                                                        $('#btnFreeze').on('click', function (e) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function (result) {
                                                                    if (parseInt(result) > 0) {
                                                                        var frameSrc = "${pageContext.request.contextPath}/GeneratePDF?argument_type=freezeBenList&argument=1&finYr=" + finYr + "&instl=" + instl + "&instlName=" + instlName + "&officeId=" + officeId + "&schemeId=" + schemeId + "&schemeName=" + schemeName + "&status=" + status + "&userflag=" + userflag;
                                                                        $('#eSignForm').html("");
                                                                        $('#eSignForm').removeClass("d-block").addClass("d-none");
                                                                        $('#pdfViewDiv').removeClass("d-none").addClass("d-block");
                                                                        $('#pdfViewDiv object').attr('data', frameSrc);
                                                        ...
                                                        $('#btnEsign').on('click', function (e) {
                                                            ...
                                                            var frameSrc = "";
                                                            if (applId !== '') {
                                                                frameSrc = "${pageContext.request.contextPath}/esign_certificate_request?purpose=1&serviceId=2&esignApplId=" + applId;
                                                            } else {
                                                                frameSrc = "${pageContext.request.contextPath}/esign_certificate_request?purpose=1&serviceId=2";
                                                            }
