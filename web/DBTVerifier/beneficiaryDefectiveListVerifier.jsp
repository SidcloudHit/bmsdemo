    ...
    <script>
        $(document).ready(function () {
            ...
            table1 = $('#beneficiaryListCitizen').DataTable({
                "ajax": {
                    "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtrptmverbenDefectivecit=1&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status,
                    "type": "POST"
                },
                dom: 'Bfrtip',
                "iDisplayLength": 50,
                ...
                "columns": [
                    ...
                    {"data": function (data, type, dataToSet) {
                            return  "<a href=\"${pageContext.request.contextPath}/Reports/viewCitizenDocumentForUnfreeze.jsp?aid=" + data.application_id + "~1\" target=\"_blank\"><button class=\"btn btn-primary btn-sm\" id=\"btnViewFile\" name=\"btnViewFile\">View Application</button></a>";
                        }}
