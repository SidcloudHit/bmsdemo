<%-- 
    Document   : dbtVerifierTaskList
    Created on : Aug 1, 2020, 12:35:36 PM
    Author     : NIC-Arindam
--%>
...
<html>
    <head>
        ...
        <title>Agriculture, Tripura || DBT Verifier Task List</title>
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="text-white">DBT Verifier Task List:</h4>
                        </div>
