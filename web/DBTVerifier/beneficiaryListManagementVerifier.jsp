<%-- 
    Document   : beneficiaryListManagementVerifier
...
<%
    ...
    if (!userId.equals("")) {
        ...
        if (cm.isUrlAllowed(deptId, roleId, urlId)) {
            ...
            int edit = 0;
            String ddlSchemes = "", ddlDist = "", ddlOffice = "", route = "";
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select id="ddlAction" name="ddlAction" class="form-control" required="required">
                                                    ...
                                                    <option value="13">Defective</option>
                                                    <option value="14">Reject</option>                                                    
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-4">
                                            ...
                                            <a href="${pageContext.request.contextPath}/DBTVerifier/beneficiaryFreezeListVerifier.jsp" class="btn btn-success btn-block">
                                                View Freeze And e-sign Beneficiary List
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a href="${pageContext.request.contextPath}/DBTVerifier/beneficiaryDefectiveListVerifier.jsp" class="btn btn-success btn-block">
                                                View Defective Beneficiary List
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a href="${pageContext.request.contextPath}/DBTVerifier/beneficiaryEsignListVerifier.jsp" class="btn btn-success btn-block">
                                    ...
                                    <div class="row d-none" id="benListDiv">
                                        <div class="col-md-12"> 
                                            ...
                                            <div id="citizen_route">
                                                ...
                                                <!--                                                <div class="row">
                                                                                                    <div class="input-group mb-3 col-md-12">
                                                                                                        <table id="beneficiaryListCitizen_deffective" class="table table-sm table-striped table-bordered" style="width:100%">
                                                                                                            <thead>
                                                                                                                <tr>
                                                                                                                                                                                        <th></th>
                                                                                                                    <th>Beneficiary ID</th>
...
<script charset="utf8" src="${pageContext.request.contextPath}/DataTables/pdfmake-0.1.36/vfs_fonts.js"></script>-->
    <script>
                                                        $(document).ready(function () {
                                                            ...
                                                            //checkBeneficiaryRoute(this.value);
                                                            var table, table1;
                                                            var i = 1;
                                                            ...
                                                            table = $('#beneficiaryList').DataTable({
                                                                ...
                                                                "fnDrawCallback": function () {
                                                                    ...
                                                                    table1 = $('#beneficiaryListCitizen').DataTable({
                                                                        "ajax": {
                                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtrptmverbencit=1&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status,
                                                                            "type": "POST"
                                                                        },
//                                                                        "columnDefs": [
//                                                                            {
...
//                                                                            {"data": "rc_mem", "width": "5%"},
                                                                            ...
                                                                            {"data": "ifsc"},
                                                                            {"data": function (data, type, dataToSet) {
                                                                                    return  "<a href=\"${pageContext.request.contextPath}/Reports/viewCitizenDocuments.jsp?aid=" + data.appl_id + "\"><button class=\"btn btn-primary btn-sm\" id=\"btnViewFile\" name=\"btnViewFile\">View Application</button></a>";
                                                                                }},
                                                                            {"data": function (data, type, dataToSet) {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function (result) {
                                                                        if (parseInt(result) > 0) {
                                                                            ...
                                                                            //  var frameSrc = "${pageContext.request.contextPath}/GeneratePDFBen?argument_type=freezeBenList&argument=1&officeId=" + officeId + "&schemeId=" + schemeId + "&schemeName=" + schemeName + "&status=" + status + "&userflag=" + userflag;
                                                                            //var iframeElement = $("#myModal iframe");
...
//                                                                        $('#btnEsign').removeClass("d-none").addClass("d-block");
                                                            ...
                                                            $('#btnRaiseQuerySave').on('click', function (e) {
                                                                ...
                                                                $.ajax({
                                                                    url: "${pageContext.request.contextPath}/RaiseQuery?raiseQuery=1&checkerOffice=" + officeId + "&schemeId=" + schemeId + "&applicationId=" + applicationId + "&applicantName=" + applicantName + "&actionRemarks=" + actionRemarks + "&action=" + action,
                                                                    type: "POST",
                                                                    async: false,
                                                                    dataType: "text",
                                                                    success: function (result) {
