                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    %>
                                    <form id="frmLogin" action="AdminLogin" method="post" onsubmit="return converthash();">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="submit" id="btnAdminLogin" name="btnAdminLogin" class="btn btn-success btn-block">
