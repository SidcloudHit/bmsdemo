                                ...
                                <div class="card-body bg-light">
                                    <div class="row"> 
                                        <div class="col-md-4">
                                            ...
                                            <a href="${pageContext.request.contextPath}/DBTApprover/beneficiaryApprovalforDBTCashDirectEsign.jsp" class="btn btn-success btn-block">
                                                E-sign Freezed Beneficiary List
                                            </a>
                                        </div>
                                        <div class="form-group col-md-4 required">
                                            ...
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="pay_calc" id="pay_calc" value="1" >
                                                    <label class="form-check-label" for="inlineRadio2">Payment Calculated</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="pay_calc" id="pay_not_calc" value="2"  checked="">
                                                    <label class="form-check-label" for="inlineRadio2">Payment Not Calculated</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!--                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="ddlSubDiv">Beneficiary Account Status </label>
                                            <div class="input-group mb-3">
                                                <select id="ddlbeneficiaryvalidation" name="ddlbeneficiaryvalidation" class="form-control form-control-sm" > <!-- onchange="resetBlock(2);"dependentDropDown2('ddlOfficeChecker', 'ddlSchemes', 'txtWorkflow', 'ddlOfficeMaker', 'fillChildOffice'); -->
                                                    <option value="1" selected="">All</option>
                                                    <option value="2">Validated Bank Accounts</option>
                                                    <option value="3">Not Verifiable</option>
                                                </select>
                                            </div> 
                                        </div>       
                                    ...
                                    <div class="row d-none" id="benListDiv">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row" id="divSchemeMapping"> 
                                                ...
                                                <div class="input-group mb-3 col-md-4">
                                                    <button type="button" id="btnPaymentCalc" name="btnPaymentCalc" class="btn btn-success btn-block">
...
//                                                                "ajax": {
//                                                                    url: "${pageContext.request.contextPath}/EsignWorks?paymentFileList=1&officeId=" + officeId + "&schemeId=" + schemeId + "&finYr=" + finYr + "&instl=" + instl,
//                                                                    "type": "POST"
//                                                                },
//                                                                "iDisplayLength": 50,
//                                                                'order': [[1, 'asc']],
...
//                                                        });
                                                        ...
                                                        $('#btnSearch').on('click', function (e) {
                                                            ...
                                                            var ddlbeneficiaryvalidation = $('#ddlbeneficiaryvalidation').val();
                                                            var land = true;//$('#chkBxAllowNoLand').is(":checked") ? true : false;
                                                            var is_calculated = $('input[name="pay_calc"]:checked').val();
                                                            ...
                                                            if (is_calculated === '1') {
                                                                $('#btnFreeze').css('display', 'block');
                                                                $('#btnPaymentCalc').css('display', 'none');
                                                            }
                                                            if (is_calculated === '2') {
                                                                $('#btnPaymentCalc').css('display', 'block');
                                                                $('#btnFreeze').css('display', 'none');
                                                            }
                                                            ...
                                                            table = $('#beneficiaryList').DataTable({
                                                                "ajax": {
                                                                    "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtappdirect=1&finYr=" + finYr + "&instl=" + instl + "&officeId=" + officeId + "&checkerOfficeId=" + checkerOfficeId + "&schemeId=" + schemeId + "&land=" + land + "&ddlbeneficiaryvalidation=" + ddlbeneficiaryvalidation + "&is_calculated=" + is_calculated,
                                                                    "type": "POST"
                                                                },
                                                                "columnDefs": [
                                                                    {
                                                                ...
                                                                "columns": [
                                                                    {"data": "rc_mem"},
                                                                    {"data": "rc_mem", "width": "8%"},
                                                                    {"data": "full_name", "width": "8%"},
                                                                    {"data": "guardian_name", "width": "8%"},
                                                                    {"data": function (data, type, dataToSet) {
                                                                            ++i;
                                                                            return  data.district + ", " + data.subdivision + ", " + data.block_mc_np_adc_nonadc + ", " + data.gp_ward_name;
                                                                        }, "width": "20%"},
                                                                    {"data": "office_name", "width": "16%"},
                                                                    {"data": "bank_account", "width": "8%"},
                                                                    {"data": "ifsc", "width": "7%"},
                                                                    //{"data": "scheme_name"},
                                                                    {"data": function (data, type, dataToSet) {
                                                                            var status;
                                                                            if (data.bank_account_validation_status === 'Success') {
                                                                                status = "<strong>Status: </strong> <span class=text-success>" + data.bank_account_validation_status + "</span>";
                                                                            } else {
                                                                                status = "<strong>Status: </strong> " + data.bank_account_validation_status;
                                                                            }
                                                                            if (data.beneficiary_name_match_status !== '') {
                                                                                status += "<br/><strong>Name Matching Status: </strong>" + data.beneficiary_name_match_status;
                                                                            }
                                                                            if (data.beneficiary_name_as_per_bank !== '') {
                                                                                status += "<br/><strong>Name as per Bank: </strong>" + data.beneficiary_name_as_per_bank;
                                                                            }
                                                                            return status;
                                                                    ...
                                                                    {"data": function (data, type, dataToSet) {
                                                                            var elgAmount;
//                                                                            if (data.eligible_dbt_amount !== 'NA') {
...
// Calculate payment
                                                        $('#btnPaymentCalc').on('click', function (e) {
                                                            ...
                                                            $.ajax({
                                                                url: "${pageContext.request.contextPath}/DBTApproveCash?finYr=" + finYr + "&instl=" + instl + "&amount=" + amount + "&schemeId=" + schemeId + "&land=" + land + "&reqType=2",
                                                                //url: "${pageContext.request.contextPath}/DBTInitiate?finYr=" + finYr + "&instl=" + instl + "&amount=" + amount + "&distId=" + distId + "&subdivId=" + subdivId + "&schemeId=" + schemeId + "&land=" + land,
                                                                type: "POST",
                                                                async: false,
                                                                dataType: 'json',
                                                                ...
                                                                success: function (data) {
                                                                    ...
                                                                    //$("#hdnFileName").val(data.fileName);
                                                                    //$("#msgDiv").html("DBT File for " + data.nob + " beneficiaries created successfully ");
                                                                    $("#msgDiv").html("Number of DBT beneficiary successfully sent for Payment Calculation is " + data);
                                                                    // $('#btnSearch').click();
                                                                    /*Diable all Form Fields*/
...
//                                                    }
                                                            ...
                                                            $.ajax({
                                                                url: "${pageContext.request.contextPath}/DBTFreezeCash?direct=1&finYr=" + finYr + "&instl=" + instl + "&amount=" + amount + "&schemeId=" + schemeId + "&status=" + status + "&userflag=" + userflag,
                                                                type: "POST",
                                                                async: false,
                                                                dataType: 'json',
                                                                data: {json: json},
...
//                                                                        var frameSrc = "${pageContext.request.contextPath}/GeneratePDF?argument_type=freezeBenList&argument=1&direct=1&finYr=" + finYr + "&instl=" + instl + "&instlName=" + instlName + "&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status + "&userflag=" + userflag + "&checkerofficeid=" + checkerOfficeId; //&schemeName=" + schemeName + "
//                                                                        $('#eSignForm').html("");
//                                                                        $('#eSignForm').removeClass("d-block").addClass("d-none");
//                                                                        $('#pdfViewDiv').removeClass("d-none").addClass("d-block");
//                                                                        $('#pdfViewDiv object').attr('data', frameSrc);
