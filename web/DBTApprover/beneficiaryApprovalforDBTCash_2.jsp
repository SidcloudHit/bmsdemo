                        ...
                        <div class="card-body bg-form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="ddlOffice" name="ddlOffice" class="form-control form-control-sm" required="required" onchange="resetBlock(2);dependentDropDown('ddlOffice', 'ddlOfficeChecker', 'fillChildOffice');">
                                            <%=ddlOffice%>                                                  
                                        </select>
                                    </div> 
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="ddlSubDiv">DBT Verified By</label>
                                    <div class="input-group mb-3">
                                        <select id="ddlOfficeChecker" name="ddlOfficeChecker" class="form-control form-control-sm" required="required" onchange="resetBlock(2);dependentDropDown('ddlOfficeChecker', 'ddlOfficeMaker', 'fillChildOffice');">
                            ...
                            <div class="row" id="divSchemeMapping">                                
                                <div class="input-group mb-3 col-md-2">
                                    <button type="button" id="btnAdd" name="btnAdd" class="btn btn-primary">
                                        <i class="fa fa-search">&nbsp;&nbsp;</i>Generate DBT File
                                    </button>
                                </div> 
                                <div class="input-group mb-3 col-md-2 d-none" id="filePushDiv" >
                                    <input type="hidden" id="hdnFileName" value=""/>
                                    <button type="button" id="btnPushFile" name="btnPushFile" class="btn btn-primary">
                                        <i class="fa fa-search">&nbsp;&nbsp;</i>Push DBT File
                                    </button>
                                </div>
                                            ...
                                            $(document).ready(function () {
                                                $('#btnSearch').on('click', function (e) {
                                                    ...
                                                    $('#beneficiaryList').DataTable({
                                                        "ajax": {
                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtapp=1&finYr=" + finYr + "&instl=" + instl + "&officeId=" + officeId + "&checkerOfficeId=" + checkerOfficeId + "&makerOfficeId=" + makerOfficeId + "&blockId=" + blockId + "&gpId=" + gpId + "&schemeId=" + schemeId + "&land=" + land,
                                                            "type": "POST"
                                                        },
                                                        "columnDefs": [
                                                            {
                                                ...
                                                $('#btnAdd').on('click', function (e) {
                                                    ...
                                                    $.ajax({
                                                        url: "${pageContext.request.contextPath}/DBTFileGenerationCash?finYr=" + finYr + "&instl=" + instl + "&schemeId=" + schemeId + "&land=" + land + "&reqType=1",
                                                ...
                                                $('#btnPushFile').on('click', function (e) {
                                                    $('#btnPushFile').attr("disabled", "disabled");
