<%-- 
    Document   : beneficiaryFreezeListApprover
    Created on : 1 Jan, 2022, 5:35:52 PM
    Author     : acer
--%>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="pdfViewDiv" class="bg-light">
                                    <object data="" id="pdfView" type="application/pdf" width="100%" height="600">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="input-group mb-3 col-md-6">
                                                                    <table id="fileListSub" class="table table-sm table-striped table-bordered " style="width:100%">
                                                                        <caption>File signed by Checker</caption>
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Sl No.</th>
                                                                                <th>Scheme Name</th>
                                            ...
                                            <div class="row" id="divSchemeMapping"> 
                                                <div class="input-group mb-3 col-md-4">
                                                    <button type="button" id="btnFreeze" name="btnFreeze" class="btn btn-success btn-block">
                                                        <strong>Esign Beneficiary List</strong>
                                                    </button>
                                                </div>
                                                <div class="input-group mb-3 col-md-4">
...
//               
                                                                        ...
                                                                        table3 = $('#beneficiaryListCitizen').DataTable({
                                                                            "ajax": {
                                                                                "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtrptmverbenFreezzecit=1&checkerOfficeId=" + checkerOfficeId + "&schemeId=" + schemeId + "&status=" + status,
                                                                                "type": "POST"
                                                                            },
                                                                            "columnDefs": [
                                                                                {
...
//                                                                        }}
                                                            ...
                                                            $('#btnFreeze').on('click', function (e) {
                                                                ...
                                                                var json = JSON.stringify(id);
                                                                 $.ajax({
                                                                        url: "${pageContext.request.contextPath}/GeneratePDFBen?argument_type=freezeBenList&argument=1&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status + "&userflag=" + userflag + "&checkerofficeid=" + checkerOfficeId,
                                                                        type: "POST",
                                                                        async: false,
                                                                        dataType: 'json',
                                                                ...
                                                                //});
                                                                //var frameSrc = "${pageContext.request.contextPath}/GeneratePDFBen?argument_type=freezeBenList&argument=1&officeId=" + officeId + "&schemeId=" + schemeId + "&status=" + status + "&userflag=" + userflag + "&checkerofficeid=" + checkerOfficeId + "&selectedbenid=" + json;
                                                                //var iframeElement = $("#myModal iframe");
                                                                //console.log(frameSrc);
                                                                //iframeElement.attr('src', frameSrc);
                                                                //$('#myModal').show();
...
//                                                                var row1 = table1.row($(this).parents('tr'));
                                                            ...
                                                            $('#btnRaiseQuerySave').on('click', function (e) {
                                                                ...
                                                                $.ajax({
                                                                    url: "${pageContext.request.contextPath}/RaiseQuery?raiseQuery=1&schemeId=" + schemeId + "&applicationId=" + applicationId + "&applicantName=" + applicantName + "&actionRemarks=" + actionRemarks + "&action=" + action,
                                                                    type: "POST",
                                                                    async: false,
                                                                    dataType: "text",
                                                                    success: function (result) {
