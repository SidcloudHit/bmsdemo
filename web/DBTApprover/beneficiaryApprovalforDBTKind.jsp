<%-- 
    Document   : beneficiaryApprovalforDBT
...
<%
    ...
    ddlSchemes = cm.getKindSchemes("-Please Select-");
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="text-white">Beneficiary Approval for DBT in Kind:</h4>
                        </div>
                        <div class="card-body bg-form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="ddlDistrict" name="ddlDistrict" class="form-control form-control-sm" required="required" onchange="resetBlock(7);dependentDropDown('ddlDistrict', 'ddlSubDiv', 'fillSubDiv');">
                                            <%=ddlDist%>                                                    
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="ddlSubDiv" name="ddlSubDiv" class="form-control form-control-sm" required="required" onchange="dependentDropDown('ddlSubDiv', 'ddlUrbRurBody', 'fillBlock');">
                                ...
                                <!--<div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="ddlUrbRurBody" name="ddlUrbRurBody" class="form-control form-control-sm" onchange="dependentDropDown('ddlUrbRurBody', 'ddlVlwStore', 'fillvlw');" >
                                            <option value="0">-Please Select-</option>                                                 
                                        </select>
                                    </div> 
                                </div>
                            ...
                            <!-- Modal -->
                            <div id="dbtItemModal" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-lg">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning">
                                            <h4 class="modal-title">Select Items for DBT</h4>
                                                    ...
                                                    <table id="itemList" class="table table-sm table-striped table-bordered small">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Item Name</th>
                                                                <th>Item Quantity</th>
                                                                <th>Item Selling Price per Unit</th>
                                                            </tr>
                                                        </thead> 
                                                        <tbody>
                                        ...
                                        <!--<div class="modal-footer">
                                            <button type="button" class="btn btn-default btn-sm" >Save Items</button>
                                        </div>-->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="divSchemeMapping">                                
                                <div class="input-group mb-3 col-md-4">
                                    <button type="button" id="btnAdd" name="btnAdd" class="btn btn-primary">
                                        <i class="fa fa-search">&nbsp;&nbsp;</i>Send to DBT Portal
                                    </button>
                                </div>
...
<script>
                                            $(document).ready(function () {
                                                $('#btnSearch').on('click', function (e) {
                                                    ...
                                                    if (distId === "" || (subdivId === "" || subdivId === "-1") || (blockId === "" || blockId === "-1") || (gpId === "" || gpId === "-1") || schemeId === "" || finYr === "" || instl === "") {
                                                        alert("Kindly Select Scheme, District, Subdivision, Block, GP, Financial Year and Installment for searching beneficiaries");
                                                        return false;
                                                    }
                                                    ...
                                                    $('#beneficiaryList').DataTable({
                                                        "ajax": {
                                                            "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?dbtapp=2&finYr=" + finYr + "&instl=" + instl + "&distId=" + distId + "&subdivId=" + subdivId + "&blockId=" + blockId + "&gpId=" + gpId + "&schemeId=" + schemeId + "&land=" + land,
                                                            "type": "POST"
                                                        },
                                                        "columnDefs": [
                                                            {
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                "data": null,
                                                                "defaultContent": "<button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#dbtItemModal'>View Items</button>"
                                                            }
                                                        ],
                                                        "select": {
                                                            'style': 'multi'
                                                        ...
                                                        "columns": [
                                                            ...
                                                            {"data": "father_name"},
                                                            {"data": "mobile"},
                                                            {"data": "rationcard_memberid"},
                                                            {"data": function (data, type, dataToSet) {
                                                                    i++;
                                                                    return  data.scheme_name + "<input type=\"hidden\" id=\"hdnItemDesc_" + i + "\" name=\"hdnItemDesc_" + i + "\" value=\"" + data.items + "\" />";
                                                                }},
                                                            {"data": null}
                                                        ]
                                                    });
                                                ...
                                                //DBT Modal pop up handling
                                                //$("button[data-toggle=modal]").click(function ()
                                                $('#dbtItemModal').on('show.bs.modal', function (e)
                                                {
                                                    //alert($(e.relatedTarget).attr('value'));
                                                    $('#dbtItemModal').show();
                                                    ...
                                                    //console.log(this);
                                                    var rowData = table.row($(e.relatedTarget).parents('tr')).data();

                                                    //console.log(rowData['mobile']);
                                                    var itemList = rowData['items'].split("~");

                                                    //console.log(itemList.split("#").length);
                                                    //var result = "";
                                                    for (var i = 0; i < itemList.length; i++) {
                                                        var item = itemList[i].split("-");
                                                        $("#itemList tbody").append("<tr><td>" + (i + 1) + "</td><td>" + item[1] + "</td><td>" + item[3] + " " + item[2] + "</td><td>" + item[4] + "</td> </tr>");
                                                    }
                                                    ...
                                                    /*var schemeId = $('#ddlSchemes option:selected').val();
                                                     ...
                                                     $.ajax({
                                                     cache: false,
                                                     url: "${pageContext.request.contextPath}/AjaxServlet?schmDbtItem=1&benId=" + rowData['beneficiary_id'] + "&finYr=" + finYr + "&instl=" + instl + "&schemeId=" + schemeId,
                                                     type: "POST",
                                                     success: function (result)
                                                     {
                                                     $('#dbtItemModal').show();
                                                     $("#itemList tbody").empty();
                                                     $("#itemList tbody").append(result);
                                                     }
                                                     });*/
                                                ...
                                                $('#btnAdd').on('click', function (e) {
                                                    ...
                                                    if (distId === "" || (subdivId === "" || subdivId === "-1") || (gpId === "" || gpId === "-1") || schemeId === "" || finYr === "" || instl === "") {
                                                        alert("Kindly Select Scheme, District, Subdivision, Block , GP, Financial Year and Installment for adding beneficiaries");
                                                        return false;
                                                    }
                                                    ...
                                                    $.each(rows_selected, function (index, rowId) {
                                                        ...
                                                        var b = table
                                                                .rows(function (idx, data, node) {
                                                                    return data.beneficiary_id === rowData ? true : false;
                                                                })
                                                                .data();
                                                        console.log(b[0]);
                                                        id.push(b[0]);
                                                    ...
                                                    $.ajax({
                                                        url: "${pageContext.request.contextPath}/DBTFileGenerationKind?finYr=" + finYr + "&instl=" + instl + "&distId=" + distId + "&subdivId=" + subdivId + "&gpId=" + gpId + "&schemeId=" + schemeId + "&land=" + land,
                                                        ...
                                                        data: {json: json},
                                                        success: function (result) {
                                                            $("#msgDiv").html("Beneficiaries Sent Successfully for DBT" );
                                                            $('#btnSearch').click();
                                                        }
                                                    });
                                                });
