        ...
        $(document).ready(function () {
            $('#btnSearch').on('click', function (e) {
                ...
                $('#beneficiaryList').DataTable({
                    "ajax": {
                        "url": "${pageContext.request.contextPath}/BeneficiaryDataAll?benstatusrpt=1&schemeId=" + schemeId + "&rcMem=" + rcMem + "&benName=" + benName + "&status=" + status,
                        "type": "POST"
                    },
