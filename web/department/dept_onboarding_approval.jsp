<%-- 
    Document   : dept_onboarding_approval
    Created on : Oct 16, 2021, 1:07:39 PM
    Author     : NIC-Arindam
--%>
...
<html>
    <head>
        ...
        <title>BMS || Approval:: Department On-boarding</title>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h4 class="text-white">Approval:: Department On-boarding</h4>
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#deptList').DataTable({
            "ajax": {
                "url": "${pageContext.request.contextPath}/approveddeptOnboarded",
                "type": "POST"
            },
            "iDisplayLength": 10,
            'order': [[1, 'asc']],
            ...
            "columns": [
                ...
                {"data": function (data, type, dataToSet) {
                        if (data.dept_id !== "") {
                            return '<a class="btn btn-info btn-sm" href=dept_onboarding_approval_next.jsp?data=' + data.dept_id + '>' + 'Select' + '</a>';
                        } else {
                            return "";
                        }
