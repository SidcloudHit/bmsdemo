...
<html>
    <head>
        ...
        <title>BMS || Department On-boarded List</title>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h4 class="text-white">Department On-boarded List:</h4>
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#deptList').DataTable({
            "ajax": {
                "url": "${pageContext.request.contextPath}/deptOnboardedlist",
                "type": "POST"
            },
            "iDisplayLength": 10,
            'order': [[1, 'asc']],
