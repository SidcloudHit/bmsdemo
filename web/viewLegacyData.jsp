                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <div class="row"> <span class="col-md-6"><h4 class="text-primary">View Beneficiary Data</h4></span><span class="col-md-6 text-right"><a class="btn btn-primary" href="dataValidation.jsp">View Data Validation</a></span></div>
                            </div>
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                String query_set = "SELECT scheme_id, scheme_code, fy, installment, full_name, guardians_name,"
                                        + "gender, dob, caste, aadhar,pan, rc_no, rc_mem, bank_name, ifsc, bank_account_no,"
                                        + "amount, lgd_dist_code, district_name, lgd_subdiv_code, subdivision_name, "
                                        + "lgd_block_code, block_name, lgd_gp_code, gp_name, last_mile_address FROM legacy_data.legacy_data_dump"
                                        + " Where scheme_id='" + schemeId + "' AND scheme_code='" + schemeCode + "' AND fy='" + fy + "' AND installment='" + installment + "' order by sl_no";
