...
<html>
    <head>
        ...
        <title>BMS || Change Password Page </title>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h4 class="text-white">Change User Password</h4>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form id="frmChangePassword" action="../ChangePassword">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="password" id="txtOldPwd" name="txtOldPwd" class="form-control form-control-sm" placeholder="Type Your Old Password" required="required"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control"  name="txtUType" id="txtUType" value="<%=roleId%>" >
