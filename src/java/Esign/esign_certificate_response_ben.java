 ...
 * @author Arnab
 */
@WebServlet(name = "esign_certificate_response_ben", urlPatterns = {"/esign_certificate_response_ben"})
public class esign_certificate_response_ben extends HttpServlet {
...
//            }
            ...
            if (success > 0 && status.equals("success")) //saved successful in transaction_response table
            {
                ...
                String reqDets = esign.getRequesterId(Integer.parseInt(applicationId), 2);
                ...
                int update_status = esign.updateEsignApplicationInitiation(Integer.parseInt(applicationId), fileSignedPDFFid, uId, 2); //changed by arindam
                if (update_status > 0) {
...
//                    }
                    ...
                    String[] benIds = esign.getRequestedBenList(tabName1, roleId, Integer.parseInt(applicationId));
                    BeneficiaryStatusUpdate.updateBeneficiarySignStatus(tabName, tabName1, schemeId, Integer.parseInt(applicationId), roleId, benIds);
